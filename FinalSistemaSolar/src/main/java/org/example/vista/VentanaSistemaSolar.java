...
public class VentanaSistemaSolar extends JFrame {
    ...
    public VentanaSistemaSolar(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(126, 241, 214));
        ...
        panel2.setBackground(new Color(246, 227, 130));
        ...
        panel3.setBackground(new Color(246, 227, 130));
        lblFoto = new JLabel();
        ...
        panel4.setBackground(new Color(0, 255, 225));
